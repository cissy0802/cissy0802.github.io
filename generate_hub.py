...
CARDS = [
    ...
    ("leadership", "🎯", "领导力实践", "Leadership",
     ...
     "leadership", "career"),
    ("sales", "🤝", "销售实战", "Sales",
     "发现需求、建立信任、讲价值、处理异议、成交，以及卖自己——实战话术，配上「为什么有效」的心理学与研究证据。",
     "Discovery, trust, pitching, objections, closing — and selling yourself. Real scripts, with the psychology and evidence behind why they work.",
     "sales", "career"),
    ...
    ("religions", "🕊️", "世界宗教", "World Religions",
     "犹太教、基督教、伊斯兰、印度教、道教…每期一个传统，讲清历史、分布、信仰体系与信徒实践——中立比较，不传教。",
     "Judaism, Christianity, Islam, Hinduism, Daoism… one tradition per issue — history, distribution, beliefs and practice; neutral and comparative.",
    ...
    ("novel", "📕", "小说精读", "Novels",
     "把故事讲成故事，然后一起想——一部小说一页，全剧透复述、伏笔在行文里回收，再摊开它逼你想的两难。",
     "The story told whole, then the hard questions — one novel per page: a full-spoiler retelling with its foreshadowing paid off in the prose, then the dilemmas it forces on you.",
    ...
    ("complexity", "🌀", "复杂性科学", "Complexity Science",
     "涌现、混沌、自组织临界、网络、幂律、韧性——局部规则怎么长出整体行为、为什么预测不了、以及能拿它怎么办。",
     "Emergence, chaos, self-organized criticality, networks, power laws, resilience — how local rules grow into global behavior, why it resists prediction, and what to do about it.",
...
<script defer src="/reads.js"></script>
<style>
